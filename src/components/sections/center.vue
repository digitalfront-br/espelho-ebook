...
<section 
    ...
    <div 
        ...
        class="uk-background-cover uk-height-viewport uk-flex uk-flex-center uk-flex-middle uk-scrollspy-inview uk-animation-scale-down" 
        ...
        <div 
            ...
            <h2 class="uk-heading-small uk-text-bold">{{ dados.titulo }}</h2>
